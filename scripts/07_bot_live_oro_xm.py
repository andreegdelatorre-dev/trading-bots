...
BB_DESVIACION   = 2
RSI_PERIODO     = 14
LOG_FILE        = "log_xm_gold.txt"

# ── Horario de operacion ──────────────────────────────────
# Opera sesion Londres + overlap Londres/NY
# 2:00 AM – 11:00 AM Guadalajara = 08:00 – 17:00 UTC
HORA_INICIO_UTC = 8
HORA_CIERRE_UTC = 17
...
def mercado_abierto():
    """
    Opera solo lunes a viernes dentro de la ventana:
    08:00–17:00 UTC = 2:00 AM–11:00 AM Guadalajara
    """
    ...
    while True:
        try:
            if not mercado_abierto():
                ...
                log("Fuera de horario — esperando sesion (2AM Guadalajara)")
                time.sleep(300)
                continue
